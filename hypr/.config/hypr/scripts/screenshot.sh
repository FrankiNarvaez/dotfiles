...
# Screenshot Filename
source ~/.config/frann/settings/screenshot-filename.sh

# Screenshot Folder
source ~/.config/frann/settings/screenshot-folder.sh

# Screenshot Editor
export GRIMBLAST_EDITOR="$(cat ~/.config/frann/settings/screenshot-editor.sh)"
